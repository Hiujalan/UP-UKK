<div class="sidebar-wrapper" sidebar-layout="stroke-svg">
  <div>
    <div class="logo-wrapper"><a href="<?= base_url("/be/dashboard") ?>"><img style="width: 50px;" class="img-fluid for-light" src="<?= base_url() ?>/image/<?= $settingsData['logo']; ?>" alt=""><img class="img-fluid for-dark" src="<?= base_url() ?>/image/<?= $settingsData['logo']; ?>" alt=""></a>
      <div class="back-btn"><i class="fa fa-angle-left"></i></div>
      <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
    </div>
    <div class="logo-icon-wrapper"><a href="<?= base_url("/be/dashboard") ?>"><img style="width: 50px;" class="img-fluid" src="<?= base_url() ?>/image/<?= $settingsData['logo']; ?>" alt=""></a></div>
    <nav class="sidebar-main">
      <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
      <div id="sidebar-menu">
        <ul class="sidebar-links" id="simple-bar">
          <li class="back-btn"><a href="<?= base_url("/be/dashboard") ?>"><img class="img-fluid" src="<?= base_url() ?>/image/<?= $settingsData['logo']; ?>" alt=""></a>
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("be/dashboard") ?>">
          ...
          <li class="sidebar-list">
            <label class="badge badge-light-secondary"><?= $jumlahValidasiPesanan; ?></label>
            <a class="sidebar-link sidebar-title link-nav" href="<?= base_url("be/pesanan/pesanan") ?>">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list">
            ...
            <ul class="sidebar-submenu">
              <li><a href="<?= base_url("be/produk/barang") ?>">Barang</a></li>
              <li><a href="<?= base_url("be/produk/jasa") ?>">Jasa</a></li>
            </ul>
          </li>

          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("be/produk/spesifikasi") ?>">
              <svg class="stroke-icon">
                <use href="<?= base_url() ?>/assets/svg/icon-sprite.svg#stroke-task"></use>
              </svg>
              <svg class="fill-icon">
                <use href="<?= base_url() ?>/assets/svg/icon-sprite.svg#fill-task"> </use>
              </svg><span>Spesifikasi Produk</span></a></li>

          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("be/produk/satuan") ?>">
              <svg class="stroke-icon">
              ...
              </svg><span>Satuan</span></a></li>

          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("be/produk/bank") ?>">
              <svg class="stroke-icon">
              ...
              </svg><span>Bank</span></a></li>

          <!-- <li class="sidebar-list">
            <label class="badge badge-light-secondary">2</label>
            <a class="sidebar-link sidebar-title" href="#">
              <svg class="stroke-icon">
              ...
              </svg> <span> Provinsi </span>
            </a>
            <ul class="sidebar-submenu">
              <li><a href="<?= base_url("be/produk/provinsi") ?>">Provinsi</a></li>
              <li><a href="<?= base_url("be/produk/kabupaten") ?>">Kabupaten</a></li>
              <li><a href="<?= base_url("be/produk/kecamatan") ?>">Kecamatan</a></li>
            </ul>
          </li> -->

          <?php if ($userDataLogin['role'] == '1') { ?>
            ...
            <li class="sidebar-list">
              ...
              <a class="sidebar-link sidebar-title" href="#">
                ...
                </svg> <span> All Users </span>
              </a>
              <ul class="sidebar-submenu">
                <li><a href="<?= base_url("be/users/operator") ?>">Operator</a></li>
                <li><a href="<?= base_url("be/users/user") ?>">Users</a></li>
              </ul>
            </li>

            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("be/settings/settings") ?>">
                <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("file-manager") ?>">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("bookmark") ?>">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("contacts") ?>">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("task") ?>">
              <svg class="stroke-icon">
                <use href="<?= base_url() ?>/assets/svg/icon-sprite.svg#stroke-task"></use>
              </svg>
              <svg class="fill-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("calendar-basic") ?>">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("social-app") ?>">
              <svg class="stroke-icon">
                <use href="<?= base_url() ?>/assets/svg/icon-sprite.svg#stroke-social"></use>
              </svg>
              <svg class="fill-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("to-do") ?>">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("search") ?>">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("sample-page") ?>">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("internationalization") ?>">
              <svg class="stroke-icon">
                <use href="<?= base_url() ?>/assets/svg/icon-sprite.svg#stroke-internationalization"></use>
              </svg>
              <svg class="fill-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="#" target="_blank">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("faq") ?>">
              <svg class="stroke-icon">
                <use href="<?= base_url() ?>/assets/svg/icon-sprite.svg#stroke-faq"></use>
              </svg>
              <svg class="fill-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("knowledgebase") ?>">
              <svg class="stroke-icon">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="<?= base_url("support-ticket") ?>">
              <svg class="stroke-icon">
