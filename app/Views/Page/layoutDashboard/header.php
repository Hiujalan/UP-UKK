      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown pe-0 py-0">
          <div class="media profile-media"><img class="b-r-10" src="<?= base_url() ?>/assets/images/dashboard/profile.png" alt="">
            <div class="media-body"><span><?= $userDataLogin['nama']; ?></span>
              <?php if ($userDataLogin['role'] == '1') { ?>
                <p class="mb-0 font-roboto">Admin <i class="middle fa fa-angle-down"></i></p>
              <?php } elseif ($userDataLogin['role'] == '2') { ?>
                <p class="mb-0 font-roboto">Operator <i class="middle fa fa-angle-down"></i></p>
              <?php } ?>
            </div>
          </div>
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li><a href="<?= base_url('login/logout'); ?>"><i data-feather="log-in"> </i><span>Log Out</span></a></li>
          </ul>
        </li>
      </ul>
    </div>
