...
<div class="container-fluid">
  <div class="page-title">
    <div class="row">
      <div class="col-6">
        <h3>
          Dashboard Pemasaran Unit Produksi</h3>
      </div>
      <div class="col-6">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Unit Produksi</li>
        </ol>
      </div>
    </div>
  </div>
    ...
    <div class="col-xxl-10 col-md-12 box-col-8 grid-ed-12">
      <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card o-hidden">
                <div class="card-body balance-widget"><span class="f-w-500 f-light">Total Pesanan</span>
                  <h4 class="mb-3 mt-1 f-w-500 mb-0 f-22">Rp.<span class="counter"><?= $totalPesanan; ?> </span><span class="f-light f-14 f-w-400 ms-1">Dari Semua Pesanan</span></h4><br><br>
            ...
            <div class="col-6">
              <div class="card small-widget">
                <div class="card-body primary"> <span class="f-light">Pesanan</span>
                  <div class="d-flex align-items-end gap-1">
                    <h4><?= $jumlahPesanan; ?></h4><span class="font-primary f-12 f-w-500"><i class="icon-arrow-up"></i></span>
                  </div>
            ...
            <div class="col-6">
              <div class="card small-widget">
                <div class="card-body warning"><span class="f-light">Pelanggan</span>
                  <div class="d-flex align-items-end gap-1">
                    <h4><?= $jumlahPelanggan; ?></h4><span class="font-warning f-12 f-w-500"><i class="icon-arrow-up"></i><span></span></span>
                  </div>
                  <div class="bg-gradient">
                    <svg class="stroke-icon svg-fill">
              ...
              <div class="card-body pt-0">
                <div class="appointment-table customer-table table-responsive">
                  <table class="table table-bordernone">
                    <tbody>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle me-2" src="<?= base_url() ?>/assets/images/dashboard/user/1.jpg" alt="user"></td>
                        <td class="img-content-box"><a class="f-w-500" href="<?= base_url("user/user-profile") ?>">Jane Cooper</a><span class="f-light">alma.lawson@gmail.com</span></td>
                      </tr>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle me-2" src="<?= base_url() ?>/assets/images/dashboard/user/2.jpg" alt="user"></td>
                        <td class="img-content-box"><a class="f-w-500" href="<?= base_url("user/user-profile") ?>">Cameron Willia</a><span class="f-light">tim.jennings@gmail.com</span></td>
                      </tr>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle me-2" src="<?= base_url() ?>/assets/images/dashboard/user/9.jpg" alt="user"></td>
                        <td class="img-content-box"><a class="f-w-500" href="<?= base_url("user/user-profile") ?>">Floyd Miles</a><span class="f-light">kenzi.lawson@gmail.com</span></td>
                      </tr>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle me-2" src="<?= base_url() ?>/assets/images/dashboard/user/5.jpg" alt="user"></td>
                        <td class="img-content-box"><a class="f-w-500" href="<?= base_url("user/user-profile") ?>">Dianne Russell</a><span class="f-light">curtis.weaver@gmail.com</span></td>
                      </tr>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle me-2" src="<?= base_url() ?>/assets/images/dashboard/user/3.jpg" alt="user"></td>
                        <td class="img-content-box"><a class="f-w-500" href="<?= base_url("user/user-profile") ?>">Guy Hawkins</a><span class="f-light">curtis.weaver@gmail.com</span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <div class="row g-sm-3 g-2">
                    <div class="col-md-12">
                      <div class="light-card balance-card widget-hover">
                        <div class="svg-box">
                          <svg class="svg-fill">
                            <use href="<?= base_url() ?>/assets/svg/icon-sprite.svg#orders"></use>
                          </svg>
                        </div>
        ...
        <div class="col-xxl-3 col-xl-4 col-sm-6 box-col-6 wow zoomIn">
          <div class="card purchase-card discover"><img class="img-fluid" src="<?= base_url() ?>/assets/images/dashboard-2/discover.png" alt="vector discover">
            ...
            <div class="card-body pt-0">
              <div class="recent-sliders">
                <div class="nav nav-pills" id="v-pills-tab" role="tablist">
                  <button class="active frame-box" id="v-pills-shirt-tab" data-bs-toggle="pill" data-bs-target="#v-pills-shirt" type="button" role="tab" aria-controls="v-pills-shirt" aria-selected="true"><span class="frame-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/1.png" alt="vector T-shirt"></span></button>
                  <button class="frame-box" id="v-pills-television-tab" data-bs-toggle="pill" data-bs-target="#v-pills-television" type="button" role="tab" aria-controls="v-pills-television" aria-selected="false"><span class="frame-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/2.png" alt="vector television"></span></button>
                  <button class="frame-box" id="v-pills-headphone-tab" data-bs-toggle="pill" data-bs-target="#v-pills-headphone" type="button" role="tab" aria-controls="v-pills-headphone" aria-selected="false"><span class="frame-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/3.png" alt="vector headphone"></span></button>
                  <button class="frame-box" id="v-pills-chair-tab" data-bs-toggle="pill" data-bs-target="#v-pills-chair" type="button" role="tab" aria-controls="v-pills-chair" aria-selected="false"><span class="frame-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/4.png" alt="vector chair"></span></button>
                  <button class="frame-box" id="v-pills-lamp-tab" data-bs-toggle="pill" data-bs-target="#v-pills-lamp" type="button" role="tab" aria-controls="v-pills-lamp" aria-selected="false"><span class="frame-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/5.png" alt="vector lamp"></span></button>
                </div>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/4.png" alt="t-shirt"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">T-shirt</a></h6><span class="f-light f-12">Id : #CFDE-2163</span>
                                </div>
                              </div>
                            </td>
                            ...
                            <td class="f-w-500">
                              <div class="recent-status font-success">
                                <svg class="me-1">
                                  <use href="<?= base_url() ?>/assets/svg/icon-sprite.svg#24-hour"> </use>
                                </svg>Verified
                              </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/3.png" alt="t-shirt"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">Pink T-shirt</a></h6><span class="f-light f-12">Id : #CFDE-2780</span>
                                </div>
                              </div>
                            </td>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/5.png" alt="television"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">Sony</a></h6><span class="f-light f-12">Id : #CFDE-2163</span>
                                </div>
                              </div>
                            </td>
                            <td class="f-w-500">X1</td>
                          ...
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/6.png" alt="television"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">Samsung</a></h6><span class="f-light f-12">Id : #CFDE-2780</span>
                                </div>
                              </div>
                            </td>
                            <td class="f-w-500">X2</td>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/1.png" alt="headephones"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">Sony</a></h6><span class="f-light f-12">Id : #CFDE-2163</span>
                                </div>
                              </div>
                          ...
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/2.png" alt="headephones"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">Sennheiser</a></h6><span class="f-light f-12">Id : #CFDE-2780</span>
                                </div>
                              </div>
                            </td>
                            <td class="f-w-500">X2</td>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/7.png" alt="chair"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">Chair</a></h6><span class="f-light f-12">Id : #CFDE-2163</span>
                                </div>
                              </div>
                            </td>
                            <td class="f-w-500">X1</td>
                          ...
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/8.png" alt="chair"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">Office chair</a></h6><span class="f-light f-12">Id : #CFDE-2780</span>
                                </div>
                              </div>
                            </td>
                            <td class="f-w-500">X2</td>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/9.png" alt="lamp"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">Lamp</a></h6><span class="f-light f-12">Id : #CFDE-2163</span>
                                </div>
                              </div>
                            </td>
                            <td class="f-w-500">X1</td>
                          ...
                          <tr>
                            <td>
                              <div class="product-content">
                                <div class="order-image"><img src="<?= base_url() ?>/assets/images/dashboard-2/order/sub-product/10.png" alt="lamp"></div>
                                <div>
                                  <h6 class="f-14 mb-0"><a href="<?= base_url("ecommerce/order-history") ?>">Bedside lamp</a></h6><span class="f-light f-12">Id : #CFDE-2780</span>
                                </div>
                              </div>
                            </td>
                            <td class="f-w-500">X2</td>
      ...
      <div class="card">
        ...
        <div class="card-body pt-0">
          <ul class="categories-list">
            <li class="d-flex">
              <div class="bg-light"> <img src="<?= base_url() ?>/assets/images/dashboard-2/category/1.png" alt="vector burger"></div>
              <div>
                <h6 class="mb-0"><a href="<?= base_url("ecommerce/product") ?>">Food & Drinks</a></h6><span class="f-light f-12 f-w-500">(12,200)</span>
              </div>
            </li>
            <li class="d-flex">
              <div class="bg-light"> <img src="<?= base_url() ?>/assets/images/dashboard-2/category/2.png" alt="vector furniture"></div>
              <div>
                <h6 class="mb-0"><a href="<?= base_url("ecommerce/product") ?>">Furniture</a></h6><span class="f-light f-12 f-w-500">(7,510)</span>
              </div>
            </li>
            <li class="d-flex">
              <div class="bg-light"> <img src="<?= base_url() ?>/assets/images/dashboard-2/category/3.png" alt="vector grocery box"></div>
              <div>
                <h6 class="mb-0"><a href="<?= base_url("ecommerce/product") ?>">Grocery</a></h6><span class="f-light f-12 f-w-500">(15,475)</span>
              </div>
            </li>
            <li class="d-flex">
              <div class="bg-light"> <img src="<?= base_url() ?>/assets/images/dashboard-2/category/4.png" alt="vector game remote"></div>
              <div>
                <h6 class="mb-0"><a href="<?= base_url("ecommerce/product") ?>">Electronics</a></h6><span class="f-light f-12 f-w-500">(27,840)</span>
              </div>
            </li>
            <li class="d-flex">
              <div class="bg-light"> <img src="<?= base_url() ?>/assets/images/dashboard-2/category/5.png" alt="vector toys"></div>
              <div>
                <h6 class="mb-0"><a href="<?= base_url("ecommerce/product") ?>">Toys & Games</a></h6><span class="f-light f-12 f-w-500">(8,788)</span>
              </div>
            </li>
            <li class="d-flex">
              <div class="bg-light"> <img src="<?= base_url() ?>/assets/images/dashboard-2/category/6.png" alt="vector monitor"></div>
              <div>
                <h6 class="mb-0"><a href="<?= base_url("ecommerce/product") ?>">Desktop</a></h6><span class="f-light f-12 f-w-500">(10,673)</span>
              </div>
            </li>
            <li class="d-flex">
              <div class="bg-light"> <img src="<?= base_url() ?>/assets/images/dashboard-2/category/7.png" alt="vector mobile"></div>
              <div>
                <h6 class="mb-0"><a href="<?= base_url("ecommerce/product") ?>">Mobile & Accessories</a></h6><span class="f-light f-12 f-w-500">(5,129) </span>
              </div>
            </li>
          </ul>
              ...
              <li class="d-flex">
                ...
                <div class="w-100 ms-3">
                  ...
                  <div class="recent-images">
                    <ul>
                      <li>
                        <div class="recent-img-wrap"><img src="<?= base_url() ?>/assets/images/dashboard-2/product/1.png" alt="chair"></div>
                      </li>
                      <li>
                        <div class="recent-img-wrap"><img src="<?= base_url() ?>/assets/images/dashboard-2/product/2.png" alt="chair"></div>
                      </li>
                      <li>
                        <div class="recent-img-wrap"><img src="<?= base_url() ?>/assets/images/dashboard-2/product/3.png" alt="men t-shirt"></div>
                      </li>
                    </ul>
                  </div>
                </div>
