        ...
        <div class="col-md-12 project-list">
            <div class="card">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-0 me-0"></div><a class="btn btn-primary" href="/projects-create"> <i data-feather="plus-square"> </i>Create New Project</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="project-box"><span class="badge badge-primary">Doing</span>
                                        ...
                                        <div class="media"><img class="img-20 me-1 rounded-circle" src="<?=base_url()?>/assets/images/user/3.jpg" alt="" data-original-title="" title="">
                                        ...
                                        <div class="customers">
                                            <ul>
                                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="<?=base_url()?>/assets/images/user/3.jpg" alt="" data-original-title="" title=""></li>
                                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="<?=base_url()?>/assets/images/user/5.jpg" alt="" data-original-title="" title=""></li>
                                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="<?=base_url()?>/assets/images/user/1.jpg" alt="" data-original-title="" title=""></li>
