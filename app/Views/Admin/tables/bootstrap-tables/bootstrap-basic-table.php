...
<div class="container-fluid basic_table">
  <div class="row">
          ...
          <table class="table">
            ...
            <tbody>
              <tr class="border-bottom-secondary">
                <th scope="row">1</th>
                <td> <img class="img-30 me-2" src="<?= base_url() ?>/assets/images/user/1.jpg" alt="profile">Ram Jacob</td>
                <td>Wolfe</td>
              ...
              <tr class="border-bottom-success">
                <th scope="row">2</th>
                <td> <img class="img-30 me-2" src="<?= base_url() ?>/assets/images/user/2.jpg" alt="profile">John Deo</td>
                <td>Gummer</td>
              ...
              <tr class="border-bottom-info">
                <th scope="row">3</th>
                <td> <img class="img-30 me-2" src="<?= base_url() ?>/assets/images/user/3.jpg" alt="profile">Elana John</td>
                <td>Cazale </td>
              ...
              <tr class="border-bottom-warning">
                <th scope="row">4</th>
                <td> <img class="img-30 me-2" src="<?= base_url() ?>/assets/images/user/7.jpg" alt="">Meryl Streep</td>
                <td>Roberts</td>
              ...
              <tr class="border-bottom-danger">
                <th scope="row">5</th>
                <td> <img class="img-30 me-2" src="<?= base_url() ?>/assets/images/user/2.png" alt="">Emma Stone</td>
                <td>Stone</td>
              ...
              <tr class="border-bottom-light">
                <th scope="row">6</th>
                <td> <img class="img-30 me-2" src="<?= base_url() ?>/assets/images/user/3.png" alt="">Eliana Jons</td>
                <td>Jons</td>
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h3>Caption</h3><span>A <code>&lt;caption&gt;</code> functions like a heading for a table. It helps users with screen readers to find a table and understand what it’s about and decide if they want to read it.</span>
        </div>
    ...
    <div class="col-sm-6">
      <div class="card">
        <div class="card-header">
          <h3>Striped Row with Inverse Table</h3><span>Use <code>.table-striped</code> to add zebra-striping to any table row within the <code></code>. This styling doesn't work in IE8 and below as :nth-child CSS selector isn't supported.</span>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h3>Breckpoint Specific</h3><span>Use <code>.table-responsive"❴-sm|-md|-lg|-xl|-xxl❵"</code> functions like a heading for a table. It helps users with screen readers to find a table and understand what it’s about and decide if they want to read it.</span>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h3>Responsive Tables With Light Background</h3><span>A <code>.table-responsive , .table-light</code> inside table element.</span>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h3>Sizing Tables</h3><span>Example of Extra large table, Add<code>.table-xl</code> class to the<code>.table</code> , Large table Add <code> .table-lg</code> , Default table Add <code>.table-de</code> , Small table Add <code>.table-sm </code>, Extra Small table Add <code>.table-xs</code>to create a table.</span>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h3>Dashed Border </h3><span>Dashed border use class <code>.table-dashed</code> , for Dotted border use class<code>.table-dotted</code>, for Double border use class<code>.table-Double</code></span>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive">
