...
<?= $this->section('css') ?>
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/css/vendors/jsgrid.css">
<?= $this->endSection() ?>
...
<script src="<?= base_url() ?>/assets/js/jsgrid/griddata.js"></script>
<script src="<?= base_url() ?>/assets/js/jsgrid/jsgrid.js"></script>
<?= $this->endSection() ?>