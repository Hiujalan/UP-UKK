...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
            ...
            <div class="card">
                ...
                <div class="card-body btn-showcase"><a class="btn btn-square btn-primary" href="#" data-toggle="tooltip" title="btn btn-primary" role="button">Link</a>
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
            ...
            <div class="card">
                ...
                <div class="card-body btn-showcase">
                    <button class="btn btn-square btn-primary-gradien" type="button" title="btn btn-square btn-primary-gradien">Primary Button</button>
                    <button class="btn btn-square btn-secondary-gradien" type="button" title="btn btn-square btn-secondary-gradien">Secondary Button</button>
                    <button class="btn btn-square btn-success-gradien" type="button" title="btn btn-square btn-success-gradien">Success Button</button>
                    <button class="btn btn-square btn-info-gradien" type="button" title="btn btn-square btn-info-gradien">Info Button</button>
                    <button class="btn btn-square btn-warning-gradien" type="button" title="btn btn-square btn-warning-gradien">Warning Button</button>
                    <button class="btn btn-square btn-danger-gradien" type="button" title="btn btn-square btn-danger-gradien">Danger Button</button>
                    <button class="btn btn-square btn-light-gradien text-dark" type="button" title="btn btn-square btn-light-gradien">Light Button</button>
                    <div class="code-box-copy">
