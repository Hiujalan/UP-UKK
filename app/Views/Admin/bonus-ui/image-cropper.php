...
<?= $this->section('css') ?>
<link rel="stylesheet" type="text/css" href="<?=base_url()?>/assets/css/vendors/image-cropper.css">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-9 col-md-12">
                                <div class="img-container"><img id="image" src="<?=base_url()?>/assets/images/other-images/img-cropper.jpg" alt="Picture"></div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="img-container"><img class="crop-zoomable img-fluid" src="<?=base_url()?>/assets/images/other-images/img-cropper.jpg" alt=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="img-container"><img class="crop-auto img-fluid" src="<?=base_url()?>/assets/images/other-images/img-cropper.jpg" alt=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="img-container"><img class="crop-drag img-fluid" src="<?=base_url()?>/assets/images/other-images/img-cropper.jpg" alt=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="img-container"><img class="crop-min img-fluid" src="<?=base_url()?>/assets/images/other-images/img-cropper.jpg" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="<?=base_url()?>/assets/js/image-cropper/cropper.js"></script>
<script src="<?=base_url()?>/assets/js/image-cropper/cropper-main.js"></script>
