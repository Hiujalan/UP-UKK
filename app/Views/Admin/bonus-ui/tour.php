...
<?= $this->section('css') ?>
<link rel="stylesheet" type="text/css" href="<?=base_url()?>/assets/css/vendors/tour.css">
            ...
            <div class="col-sm-12">
                <div class="card hovercard text-center">
                    ...
                    <div class="user-image">
                        <div class="avatar"><img alt="" src="<?=base_url()?>/assets/images/user/7.jpg" data-intro="This is Profile image"></div>
                        <a href="/edit-profile"><div class="icon-wrapper"><i class="icofont icofont-pencil-alt-5" data-intro="Change Profile image here"></i></div></a>
                    </div>
                    <div class="info">
                  ...
                  <li class="list-inline-item"><a href="https://www.facebook.com/" data-bs-original-title="" title=""><i class="fa fa-facebook"></i></a>
                  </li>
                  <li class="list-inline-item"><a href="https://account.google.com" data-bs-original-title="" title=""><i class="fa fa-google-plus"></i></a></li>
                  <li class="list-inline-item"><a href="https://twitter.com/" data-bs-original-title="" title=""><i class="fa fa-twitter"></i></a></li>
                  <li class="list-inline-item"><a href="https://www.instagram.com/" data-bs-original-title="" title=""><i class="fa fa-instagram"></i></a>
                  </li>
                  <li class="list-inline-item"><a href="https://rss.com/" data-bs-original-title="" title=""><i class="fa fa-rss"></i></a></li>
                </ul>
                        </div>
                        <div class="follow">
                            <div class="row">
            ...
            <div class="col-sm-12" data-intro="This is the your first Post">
                <div class="card">
                    <div class="profile-img-style">
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="media"><img class="img-thumbnail rounded-circle me-3" src="<?=base_url()?>/assets/images/user/7.jpg" alt="Generic placeholder image">
                        ...
                        <div class="img-container">
                            <div id="aniimated-thumbnials"><a href="javascript:void(0)"><img class="img-fluid rounded" src="<?=base_url()?>/assets/images/other-images/profile-style-img3.png" alt="gallery"></a></div>
                        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="profile-img-style">
                        ...
                        <hr>
                        <p>you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet.</p>
                        <div class="row mt-4 pictures" id="aniimated-thumbnials-2"><a class="col-sm-6" href="javascript:void(0)"><img class="img-fluid rounded" src="<?=base_url()?>/assets/images/other-images/profile-style-img.png" alt="gallery"></a><a class="col-sm-6" href="javascript:void(0)"><img class="img-fluid rounded" src="<?=base_url()?>/assets/images/other-images/profile-style-img.png" alt="gallery"></a></div>
                        <div class="like-comment mt-4">
                            <ul class="list-inline">
                                <li class="list-inline-item border-right pe-3">
                                    <label class="m-0"><a href="#"><i class="fa fa-heart"></i></a>  Like</label><span class="ms-2 counter">2659</span>
                    ...
                    <div class="profile-img-style">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xl-4">
                                <div id="aniimated-thumbnials-3"><a href="javascript:void(0)"><img class="img-fluid rounded" src="<?=base_url()?>/assets/images/blog/img.png" alt="gallery"></a></div>
...
<script src="<?=base_url()?>/assets/js/tour/intro.js"></script>
<script src="<?=base_url()?>/assets/js/tour/intro-init.js"></script>
