      ...
      <div id="sidebar-menu">
        <ul class="sidebar-links" id="simple-bar">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
              ...
              </svg><span class="lan-10">Sales</span></a>
            <ul class="sidebar-submenu">
              <li><a href="<?= base_url("sales/sales") ?>">Sales</a></li>
              <li><a href="<?= base_url("sales/faktur") ?>">Faktur</a></li>
              <li><a href="<?= base_url("sales/sign") ?>">Sign</a></li>
              <li><a href="<?= base_url("sales/penyewaan") ?>">Penyewaan</a></li>
              <li><a href="<?= base_url("sales/servis-lapangan") ?>">Servis Lapangan</a></li>
            </ul>
          </li>
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
              ...
              <svg class="fill-icon">
                <use href="<?= base_url() ?>/assets/svg/icon-sprite.svg#fill-widget"></use>
              </svg><span class="lan-10">Pengoperasian</span></a>
            <ul class="sidebar-submenu">
              <li><a href="<?= base_url("pengoperasian/akuntansi") ?>">Akuntansi</a></li>
              <li><a href="<?= base_url("pengoperasian/pengetahuan") ?>">Pengetahuan</a></li>
              <li><a href="<?= base_url("pengoperasian/proyek") ?>">Proyek</a></li>
              <li><a href="<?= base_url("pengoperasian/timesheet") ?>">TimeSheet</a></li>
              <li><a href="<?= base_url("pengoperasian/mejabantuan") ?>">Meja Bantuan</a></li>
              <li><a href="<?= base_url("pengoperasian/inventaris") ?>">Inventaris</a></li>
              <li><a href="<?= base_url("pengoperasian/pembelian") ?>">Pembelian</a></li>
              <li><a href="<?= base_url("pengoperasian/dokumen") ?>">Dokumen</a></li>
            </ul>
          </li>
