...
<link rel="stylesheet" type="text/css" href="<?=base_url()?>/assets/css/vendors/button-builder.css">
...
border-color: #00c292 #00c292 #00c292;
    ...
    <script src="<?=base_url()?>/assets/js/button-builder/colorpicker.js"></script>
    <script src="<?=base_url()?>/assets/js/button-builder/clipboard.min.js"></script>
    <script src="<?=base_url()?>/assets/js/button-builder/generator.js"></script>
    <script src="<?=base_url()?>/assets/js/button-builder/extend-1.0.js"></script>
