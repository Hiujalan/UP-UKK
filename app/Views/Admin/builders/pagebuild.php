...
<?= $this->section('css') ?>
<link rel="stylesheet" type="text/css" href="<?=base_url()?>/assets/css/vendors/page-builder.css">
...
<script src="<?=base_url()?>/assets/js/page-builder/jquery.grideditor.min.js"></script>
<script src="<?=base_url()?>/assets/js/page-builder/page-builder-custom.js"></script>
