...
<script src="<?=base_url()?>/assets/js/form-builder/form-builder-2/beautifyhtml.js"></script>
<script src="<?=base_url()?>/assets/js/form-builder/form-builder-2/form-builder-2.js"></script>
