    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="list-group"><a class="list-group-item list-group-item-action flex-column align-items-start active" href="javascript:void(0)">
                        ...
                        </a><a class="list-group-item list-group-item-action flex-column align-items-start" href="javascript:void(0)">
                            <div class="d-flex w-100 justify-content-between">
        ...
        <div class="col-sm-12 col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="list-group"><a class="list-group-item list-group-item-action" href="javascript:void(0)"><img class="rounded-circle" src="<?=base_url()?>/assets/images/user/1.jpg" alt="">Cras justo odio</a><a class="list-group-item list-group-item-action" href="javascript:void(0)"><img class="rounded-circle" src="<?=base_url()?>/assets/images/user/1.jpg" alt="">Dapibus ac facilisis in</a><a class="list-group-item list-group-item-action" href="javascript:void(0)"><img class="rounded-circle" src="<?=base_url()?>/assets/images/user/1.jpg" alt="">Morbi leo risus</a><a class="list-group-item list-group-item-action disabled" href="javascript:void(0)"><img class="rounded-circle" src="<?=base_url()?>/assets/images/user/1.jpg" alt="">Vestibulum at eros</a></div>
                </div>
            </div>
        </div>
    </div>
