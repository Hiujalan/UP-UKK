            ...
            <div class="col pr-xl-0 chat-right-aside">
              ...
              <div class="chat">
                ...
                <div class="chat-header clearfix">
                  <div class="media align-items-center"> <img class="rounded-circle" src="<?=base_url()?>/assets/images/user/8.jpg" alt="">
                  ...
                  <ul class="list-inline chat-menu-icons">
                  ...
                  <div class="row">
                    <div class="col text-center pe-0 call-content">
                      <div>
                        ...
                        <div class="receiver-img"><img src="<?=base_url()?>/assets/images/other-images/receiver-img.jpg" alt=""></div>
                      </div>
                    </div>
                    <div class="col-sm-7 ps-0 caller-img"><img class="img-fluid" src="<?=base_url()?>/assets/images/other-images/caller.jpg" alt=""></div>
                  </div>
                </div>
                <!-- chat-history ends-->
                <!-- chat end-->
