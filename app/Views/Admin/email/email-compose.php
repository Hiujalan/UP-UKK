                          ...
                          <div class="card-body">
                            <div class="email-app-sidebar">
                              ...
                              <ul class="nav main-menu" role="tablist">
                                <li class="nav-item"><a class="btn-primary btn-block btn-mail show" id="pills-darkhome-tab" data-bs-toggle="pill" href="#pills-darkhome" role="tab" aria-controls="pills-darkhome" aria-selected="true"><i class="icofont icofont-envelope me-2"></i> NEW MAIL</a></li>
                                <li class="nav-item"><a id="pills-darkprofile-tab" data-bs-toggle="pill" href="#pills-darkprofile" role="tab" aria-controls="pills-darkprofile" aria-selected="false"><span class="title"><i class="icon-import"></i> Inbox</span><span class="badge pull-right">(236)</span></a></li>
                      ...
                      <div class="row">
                        <div class="col-xl-4 col-md-12 box-md-12 pr-0">
                          ...
                          <div class="inbox">
                            ...
                            <div class="media media-size-email"><img class="me-3 rounded-circle" src="<?=base_url()?>/assets/images/user/user.png" alt="">
                              <div class="media-body">
                                <h6>Lion Lorpa  <small><span>(02</span> Jun <span>2016)</span></small></h6>
                                <p>Mattis luctus. Donec nisi diam,</p>
                              </div>
                                      ...
                                      <div class="email-top">
                                        <div class="row">
                                          <div class="col-md-6 xl-100 col-sm-12">
                                            <div class="media"><img class="me-3 rounded-circle" src="<?=base_url()?>/assets/images/user/user.png" alt="">
                                              <div class="media-body">
                                      ...
                                      <div class="email-wrapper">
                                        ...
                                        <div class="attachment">
                                          <ul class="list-inline">
                                            <li class="list-inline-item"><img class="img-fluid" src="<?=base_url()?>/assets/images/email/1.jpg" alt=""></li>
                                            <li class="list-inline-item"><img class="img-fluid" src="<?=base_url()?>/assets/images/email/2.jpg" alt=""></li>
                                            <li class="list-inline-item"><img class="img-fluid" src="<?=base_url()?>/assets/images/email/3.jpg" alt=""></li>
                                          </ul>
                                        </div>
                                        <hr>
...
<script src="<?=base_url()?>/assets/js/email-app.js"></script>
<?= $this->endSection() ?>