        ...
        <div class="col-xl-9 xl-60">
            <div class="card">
                <div class="job-search">
                    <div class="card-body">
                        <div class="media"><img class="img-40 img-fluid m-r-20" src="<?=base_url()?>/assets/images/job-search/1.jpg" alt="">
            ...
            <div class="card">
                <div class="job-search">
                    <div class="card-body">
                        <div class="media"><img class="img-40 img-fluid m-r-20" src="<?=base_url()?>/assets/images/job-search/2.jpg" alt="">
                            <div class="media-body">
            ...
            <div class="card ribbon-vertical-left-wrapper">
                ...
                <div class="job-search">
                    <div class="card-body">
                        <div class="media"><img class="img-40 img-fluid m-r-20" src="<?=base_url()?>/assets/images/job-search/3.jpg" alt="">
                            <div class="media-body">
            ...
            <div class="card">
                <div class="job-search">
                    <div class="card-body">
                        <div class="media"><img class="img-40 img-fluid m-r-20" src="<?=base_url()?>/assets/images/job-search/4.jpg" alt="">
                            <div class="media-body">
            ...
            <div class="card">
                <div class="job-search">
                    <div class="card-body">
                        <div class="media"><img class="img-40 img-fluid m-r-20" src="<?=base_url()?>/assets/images/job-search/5.jpg" alt="">
                            <div class="media-body">
            ...
            <div class="card">
                <div class="job-search">
                    <div class="card-body">
                        <div class="media"><img class="img-40 img-fluid m-r-20" src="<?=base_url()?>/assets/images/job-search/6.jpg" alt="">
                            <div class="media-body">
