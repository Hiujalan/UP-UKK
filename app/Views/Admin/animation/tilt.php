    ...
    <div class="row tilt-showcase">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <div><img class="img-fluid img-thumbnail js-tilt" src="<?=base_url()?>/assets/images/lightgallry/02.jpg" data-tilt-perspective="300" data-tilt-speed="400" data-tilt-max="5" alt=""></div>
                            <div>
        ...
        <div class="col-xxl-4 box-col-6 col-lg-6">
            <div class="card height-equal">
                ...
                <div class="card-body">
                    <div class="tilt-image"><img class="img-fluid img-thumbnail js-tilt" src="<?=base_url()?>/assets/images/lightgallry/03.jpg" data-tilt-perspective="300" data-tilt-speed="400" data-tilt-max="5" alt=""></div>
                    <div>
        ...
        <div class="col-xxl-4 box-col-6 col-lg-6">
            <div class="card height-equal">
                ...
                <div class="card-body">
                    <div class="tilt-image"><img class="img-fluid img-thumbnail js-tilt" src="<?=base_url()?>/assets/images/lightgallry/04.jpg" data-tilt-glare="true" data-tilt-maxglare=".5" data-tilt-perspective="200" data-tilt-speed="300" data-tilt-max="10" alt=""></div>
                    <div>
                        <h6 class="sub-title mt-4">How to Use:</h6>
    ...
    &nbsp; glare: true,maxGlare: .5
        ...
        <div class="col-xxl-4 box-col-6 col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tilt-image"><img class="img-fluid img-thumbnail js-tilt" src="<?=base_url()?>/assets/images/lightgallry/05.jpg" data-tilt-reset="false" data-tilt-speed="200" data-tilt-max="5" data-tilt-perspective="150" alt=""></div>
                    <div>
                        <h6 class="sub-title mt-4">How to Use:</h6>
        ...
        <div class="col-xxl-4 box-col-6 col-lg-6">
            <div class="card">
                ...
                <div class="card-body o-hidden">
                    <div class="tilt-image"><img class="img-fluid img-thumbnail js-tilt" src="<?=base_url()?>/assets/images/lightgallry/06.jpg" data-tilt-speed="1000" data-tilt-max="20" data-tilt-scale="1.01" data-tilt-perspective="250" alt=""></div>
                    <div>
    ...
    &nbsp;  scale: 1.2
        ...
        <div class="col-xxl-4 box-col-6 col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tilt-image"><img class="img-fluid img-thumbnail js-tilt" src="<?=base_url()?>/assets/images/lightgallry/07.jpg" data-tilt-speed="100" data-tilt-max="10" data-tilt-axis="x" data-tilt-perspective="250" alt=""></div>
                    <div>
    ...
    &nbsp;  axis: x
        ...
        <div class="col-xxl-4 box-col-6 col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tilt-image"><img class="img-fluid img-thumbnail js-tilt" src="<?=base_url()?>/assets/images/lightgallry/08.jpg" data-tilt-speed="250" data-tilt-max="10" data-tilt-axis="y" data-tilt-perspective="250" alt=""></div>
                    <div>
