...
<div class="container-fluid">
    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header language-header">
                                ...
                                <div class="main" role="main">
                                    <div class="dropdown langChoice js-languageSelect p-0">
                                        <button class="btn dropdown-toggle" id="dropdownMenuButton" type="button" data-bs-toggle="dropdown" aria-expanded="false">English</button>
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"><a class="dropdown-item" href="#">English</a><a class="dropdown-item" href="#">German</a><a class="dropdown-item" href="#">Russian</a><a class="dropdown-item" href="#">Arabic</a></div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>How to use it</h5><span>Add a class<code>.hdg, .hdg_main, .js-languagePageHdg, .hList, .hList_loose, .masthead-nav., js-languageList, .langChoice, .js-languageSelect</code>class to any tag for language translate</span>
                </div>
                <div class="card-body">
                    <div class="language">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>How to add language</h5><span>you can also add other language according to below in js and add lanuage type in langChoice</span>
                </div>
                <div class="card-body">
...
<script src="<?=base_url()?>/assets/js/internationalization/language-picker.js"></script>
