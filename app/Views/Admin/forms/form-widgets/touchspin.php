  ...
  <div class="bootstrap-touchspin">
    <div class="row">
      ...
      <div class="col-sm-12 col-md-6">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">Decimal Value of Touchspin</h5><span>Use <code>data-bts-decimal="VALUE"</code> attribute to use decimal value of touchspin input.</span>
          </div>
          <div class="card-body">
            <fieldset>
              <div class="input-group">
      ...
      <div class="col-sm-12 col-md-6">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">Change Button Class to link</h5><span>Add <code>data-bts-button-down-class & data-bts-button-up-class</code> attribute to change button Class.</span>
          </div>
          <div class="card-body">
            <fieldset>
              <div class="input-group">
      ...
      <div class="col-sm-12 col-md-6">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">Touchspin With Icon</h5><span>Add icon class in <code>data-bts-postfix</code> attribute to icon to postfix as well prefix.</span>
          </div>
          <div class="card-body">
            <fieldset>
              <div class="input-group">
      ...
      <div class="col-sm-12 col-md-6">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">Touchspin Icon Button</h5><span>Use <code>data-bts-button-down-txt & data-bts-button-up-txt</code> attribute to set touchspin icon button.</span>
          </div>
          <div class="card-body">
            <fieldset>
              <div class="input-group">
      ...
      <div class="col-sm-12 col-md-6">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">Touchspin mousewheel Disable</h5><span>Add <code>.touchspin-stop-mousewheel</code> class to diable mousewheel.</span>
          </div>
          <div class="card-body">
            <fieldset>
              <div class="input-group">
      ...
      <div class="col-sm-12 col-md-6">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">Small Horizontal Touchspin</h5><span>Add <code>.input-group-sm</code> class to input-group.</span>
          </div>
          <div class="card-body">
            <fieldset>
