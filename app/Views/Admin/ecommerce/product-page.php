                ...
                <div class="card">
                    <div class="card-body">
                        <div class="product-slider owl-carousel owl-theme" id="sync1">
                            <div class="item"><img src="<?= base_url() ?>/assets/images/ecommerce/01.jpg" alt=""></div>
                            <div class="item"><img src="<?= base_url() ?>/assets/images/ecommerce/02.jpg" alt=""></div>
                            <div class="item"><img src="<?= base_url() ?>/assets/images/ecommerce/03.jpg" alt=""></div>
                            <div class="item"><img src="<?= base_url() ?>/assets/images/ecommerce/04.jpg" alt=""></div>
                            <div class="item"><img src="<?= base_url() ?>/assets/images/ecommerce/05.jpg" alt=""></div>
                            <div class="item"><img src="<?= base_url() ?>/assets/images/ecommerce/06.jpg" alt=""></div>
                            <div class="item"><img src="<?= base_url() ?>/assets/images/ecommerce/07.jpg" alt=""></div>
                            <div class="item"><img src="<?= base_url() ?>/assets/images/ecommerce/08.jpg" alt=""></div>
                        </div>
            ...
            <div class="col-xxl-5 box-col-6 order-xxl-0 order-1">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="m-t-15 btn-showcase"><a class="btn btn-primary" href="<?= base_url("ecommerce/cart") ?>" title=""> <i class="fa fa-shopping-basket me-1"></i>Add To Cart</a><a class="btn btn-success" href="<?= base_url("ecommerce/checkout") ?>" title=""> <i class="fa fa-shopping-cart me-1"></i>Buy Now</a><a class="btn btn-secondary" href="<?= base_url("ecommerce/list-wish") ?>"> <i class="fa fa-heart me-1"></i>Add To WishList</a></div>
                    </div>
                </div>
            </div>
