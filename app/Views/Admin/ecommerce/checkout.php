    ...
    <div class="card-body">
      <div class="row">
        <div class="col-xl-6 col-sm-12">
          <form>
            <div class="row">
              <div class="mb-md-3 mb-2 col-sm-6">
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <label class="d-block" for="edo-ani2">
                      <input class="radio_animated" id="edo-ani2" type="radio" name="rdo-ani" checked="" data-original-title="" title="">PayPal<img class="img-paypal" src="<?=base_url()?>/assets/images/checkout/paypal.png" alt="">
                    </label>
                  </div>
                </div>
              </div>
