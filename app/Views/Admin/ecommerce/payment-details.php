            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-5 text-center order-md-last order-first"><img class="img-fluid" src="<?=base_url()?>/assets/images/ecommerce/card.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="theme-form e-commerce-form row">
                        <div class="mb-md-3 mb-2 col-6 p-r-0">
                            <input class="form-control" type="text" placeholder="Full name here">
                        </div>
                        <div class="mb-md-3 mb-2 col-6">
                            <input class="form-control" type="text" placeholder="Card number">
                        </div>
                        <div class="mb-md-3 mb-2 col-6 p-r-0">
                        ...
                        <div class="mb-md-3 mb-2 col-6">
                            <select class="form-select" size="1">
                                Payment Details <option>Select Year</option>
                                <option>2015</option>
                                <option>2016</option>
                                <option>2017</option>
                                <option>2018</option>
                    ...
                    <form class="theme-form row">
                        ...
                        <div class="mb-md-3 mb-2 col-12">
                            <ul class="payment-opt">
                                <li><img src="<?=base_url()?>/assets/images/ecommerce/mastercard.png" alt=""></li>
                                <li><img src="<?=base_url()?>/assets/images/ecommerce/visa.png" alt=""></li>
                                <li><img src="<?=base_url()?>/assets/images/ecommerce/paypal.png" alt=""></li>
                            </ul>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary btn-block" type="button" title="">Submit</button>
