            ...
            <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card o-hidden welcome-card">            
                      <div class="card-body">
                        <h4 class="mb-3 mt-1 f-w-500 mb-0 f-22">Hello Jashmin<span> <img src="<?= base_url() ?>/assets/images/dashboard-3/hand.svg" alt="hand vector"></span></h4>
              ...
              <div class="col-xl-2 col-ed-3 d-xxl-block d-sm-none box-col-none">
                <div class="card get-card overflow-hidden"> 
                  ...
                  <div class="card-body pt-0">
                    <div class="get-image text-center"> <img class="img-fluid" src="<?= base_url() ?>/assets/images/dashboard-3/better.png" alt="leptop with men vector"></div>
                  </div>
                  <ul class="square-group">
                    <li class="square-1 warning"></li>
                    <li class="square-1 primary"></li>
