                      ...
                      <div class="card-body"> 
                        <div class="email-app-sidebar left-bookmark custom-scrollbar">
                          <div class="d-flex align-items-center">
                            <div class="media-size-email"><img class="me-3 img-40 rounded-circle" src="<?=base_url()?>/assets/images/user/user.png" alt=""></div>
                          ...
                          <ul class="nav main-menu">
                            ...
                            <li class="nav-item"><a href="javascript:void(0)"><span class="iconbg badge-light-success"><i data-feather="check-circle"></i></span><span class="title ms-2">Completed</span><span class="badge badge-success">3</span></a></li>
                            <li class="nav-item"><a href="javascript:void(0)"><span class="iconbg badge-light-danger"><i data-feather="cast"></i></span><span class="title ms-2">Pending</span><span class="badge badge-danger">2</span></a></li>
                            ...
                            <ul id="todo-list">
                              <li class="task">
                                <div class="task-container">
                                  ...
                                  <div class="d-flex align-items-center gap-4"><span class="badge badge-light-primary">In Progress</span>
