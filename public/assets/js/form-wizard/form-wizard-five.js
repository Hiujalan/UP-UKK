    ...
    return this.each(function () {
      ...
      function w(e) {
        ...
        if ("slide" == c.transitionEffect)
          ...
          var k = 0;
          e > h
            ? ((nextElmLeft1 = z + 10), (nextElmLeft2 = 0), (k = 0 - a(a(g, b).attr("href"), b).outerWidth()))
            : ((nextElmLeft1 = 0 - a(a(d, b).attr("href"), b).outerWidth() + 20), (nextElmLeft2 = 0), (k = 10 + a(a(g, b).attr("href"), b).outerWidth()));
          e == h
            ? ((nextElmLeft1 = a(a(d, b).attr("href"), b).outerWidth() + 20), (nextElmLeft2 = 0), (k = 0 - a(a(g, b).attr("href"), b).outerWidth()))
...
(function ($) {
  ...
  function onFinishCallback() {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      // Mengambil nilai dari input saat halaman dimuat
      var username = document.getElementById("name").value;
      var password = document.getElementById("contact").value;

      // Menggunakan nilai yang telah diambil saat halaman dimuat
      console.log("Username:", username);
      console.log("Password:", password);

      // Di sini Anda dapat melakukan apa pun yang diperlukan dengan data yang telah diambil
    });
  }
})(jQuery);
